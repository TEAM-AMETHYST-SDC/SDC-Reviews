...
CharacteristicReviews.belongsTo(Characteristics, { foreignKey: "id" });

Characteristics.hasMany(CharacteristicReviews, {
  foreignKey: "characteristic_id",
});

Characteristics.belongsTo(Review, { foreignKey: "product_id" });

Review.hasMany(Characteristics, { foreignKey: "product_id" });
